	...
	public static void Update_store() {
        ...
        if (choice == 1) {
            ...
            case 2:
                ...
                CompactDisc cd = new CompactDisc(store.getitemsInstore().size() + 1, title, category, costCd, directorCD, lengthCD, artistCD, tracks);
                store.addMedia(cd);
                break;
                case 3:
                    ...
                    Book bk = new Book(store.getitemsInstore().size() + 1, title, category, authors, costBk);
                    store.addMedia(bk);
                    break;
            }
